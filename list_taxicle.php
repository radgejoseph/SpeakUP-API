<?php
	...
	$stmt = $conn->prepare("SELECT puvs.vehicle, puvs.body_plate, IFNULL(ROUND(AVG(reviews.ratings)),0) FROM puvs LEFT JOIN reviews ON puvs.body_plate=reviews.body_plate  WHERE puvs.vehicle='taxicle' GROUP BY puvs.body_plate;");
